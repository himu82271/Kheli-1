...
@section('content')
    ...
    @if (session()->has('message'))
        <div class="w-4/5 m-auto text-center mt-10">
            ...
            <p class="w-6/6 mb-4 text-black-500 bg-white-500 rounded-2xl py-15">
                {{ session()->get('message') }}
            </p>
    ...
    @if (Auth::check())
        ...
        <div class="pt-15 w-4/5 m-auto">
            <a href="/blog/create"
                class="bg-blue-500 uppercase bg-transparent 
    ...
    @foreach ($posts as $post)
        ...
        <div class=" sm:grid grid-cols-2 gap-20 w-4/5 mx-auto py-15 border-b border-gray-200">
            ...
            <div>
                <img src="{{ asset('images/' . $post->image_path) }}" width="700" alt="Image" />
            </div>
            <div>
                ...
                @if (isset(Auth::user()->id) && Auth::user()->id==$post->user_id)
                    <span class="float-right">
                        <a class="text-gray-700 italic hover:text-gray-900 pb-1 border-b-2"
